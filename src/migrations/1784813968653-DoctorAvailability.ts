...
export class DoctorAvailability1784813968653 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."recurring_availability_type_enum" AS ENUM('STREAM', 'WAVE')`);

        await queryRunner.query(`
            CREATE TABLE "recurring_availability" (
                "id" SERIAL NOT NULL,
                "dayOfWeek" character varying NOT NULL,
                "type" "public"."recurring_availability_type_enum" NOT NULL DEFAULT 'STREAM',
                ...
                CONSTRAINT "PK_2464dd095ba418858c1aa3f4e01" PRIMARY KEY ("id")
            )
        `);

        await queryRunner.query(`CREATE TYPE "public"."custom_availability_type_enum" AS ENUM('STREAM', 'WAVE')`);

        await queryRunner.query(`
            CREATE TABLE "custom_availability" (
                "id" SERIAL NOT NULL,
                "date" date NOT NULL,
                "type" "public"."custom_availability_type_enum" NOT NULL DEFAULT 'STREAM',
                "startTime" TIME NOT NULL,
                "endTime" TIME NOT NULL,
                "duration" integer NOT NULL,
                "capacity" integer NOT NULL,
                ...
                "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
                "doctorProfileId" integer,
                CONSTRAINT "PK_e9b8fa5803ca3d6554a7ddf7045" PRIMARY KEY ("id")
            )
        `);
